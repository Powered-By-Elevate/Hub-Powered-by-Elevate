...
type CheckinTab = 'quarterly' | 'annual';
...
export function HRCheckins({ employees, checkins, reviews, onOpenModal, onCheckinUpdated, onReviewUpdated }: Props) {
    ...
    <>
      <div className="topbar">
        <div className="topbar-left">
          ...
          <p>Track quarterly check-ins and annual performance reviews</p>
        </div>
      ...
      <div className="content">
        <div className="stats-grid" style={{ gridTemplateColumns: 'repeat(4,1fr)' }}>
          ...
          <div className="stat-card">
            <div className="stat-label">Overdue Check-ins</div>
            <div className="stat-value c-red">{overdueCheckins.length}</div>
        ...
        <div className="card">
          <div style={{ display: 'flex', borderBottom: '1px solid #E5E3DC' }}>
            {(['quarterly', 'annual'] as CheckinTab[]).map(t => (
              <button
                key={t}
              ...
              >
                {t === 'quarterly' ? 'Quarterly Check-ins' : 'Annual Reviews'}
                <span style={{
                  ...
                  {t === 'quarterly' ? checkins.length : reviews.length}
                </span>
              </button>
            ))}
          </div>
